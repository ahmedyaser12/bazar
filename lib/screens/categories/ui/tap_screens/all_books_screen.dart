...
import 'package:tuple/tuple.dart'; // Make sure to add this package if not already included
      ...
      builder: (context, tuple) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (ctx, index) {
            return Center(child: BuildBook(categoryList: allCategoryList[0])); // Corrected to use index
          },
